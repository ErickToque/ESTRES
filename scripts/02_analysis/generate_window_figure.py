...
# Configuración estilo IEEE (sin Times New Roman para compatibilidad)
plt.rcParams.update({
    'font.size': 10,
...
for w, acc in zip(windows, accuracies):
    if w in [1, 5, 30]:
...
plt.tight_layout()
plt.savefig('figures/window_optimization.png', dpi=300, bbox_inches='tight')
plt.close()
print('✅ Figura guardada: figures/window_optimization.png')
